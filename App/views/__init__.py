...
from .admin_viewreport import admin_viewreport_views


views = [user_views, index_views, auth_views, signup_views, dashboard_views,download_views,generate_views, upload_sheet_views, viewreport_views, admin_upload_template_views, admin_dashboard_views,admin_viewreport_views] 
